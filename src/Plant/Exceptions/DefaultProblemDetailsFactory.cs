...
public sealed class DefaultProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    private void ApplyProblemDetailsDefaults(HttpContext httpContext, ProblemDetails problemDetails, int statusCode)
    {
        ...
        // TODO: Возможно мне больше не нужно переписывать дефолтную реализацию,
        // попробовать установить errors через тот configure ниже...
        if (httpContext?.Items[Constants.Errors] is object errors)
        {
            problemDetails.Extensions[Constants.Errors] = errors;
        }
